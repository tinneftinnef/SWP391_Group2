...
public class SearchProduct extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (keyword != null && !keyword.trim().isEmpty()) {
            Map<Categories, List<Products>> productsByCategory = productDAO.searchProductsByCategoryName(keyword);
            request.setAttribute("products", productsByCategory);
        }
        request.getRequestDispatcher("/Layout/searchResults.jsp").forward(request, response);
    }
