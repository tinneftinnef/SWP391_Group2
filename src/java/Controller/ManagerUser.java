...
public class ManagerUser extends HttpServlet {
    ...
    String currentaccname = request.getParameter("accNamecurrent"); 
    ...
    if (request.getParameter("add") != null) {
        if (adao.isAccnameExist(accname)) {
            ...
            request.setAttribute("error", "accName already exists");
            request.getRequestDispatcher("createCustomer.jsp").forward(request, response);
        } else {
    ...
    if (request.getParameter("update") != null) {
        if (!accname.equals(currentaccname) && adao.isAccnameExist(accname)) {
            request.setAttribute("name", name);
            request.setAttribute("phone", phone);
            request.setAttribute("address", address);
            request.setAttribute("email", email);
