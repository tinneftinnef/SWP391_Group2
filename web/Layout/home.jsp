        ...
        <div class="container">
            <div class="row">
                <div class="display-header d-flex justify-content-between pb-3">
                    <h2 class="display-7 text-dark text-uppercase">Top 5 product best selling</h2>
                </div>
    ...
    <c:forEach var="entry" items="${productsByCategory}">
        <section id="windows" class="product-store position-relative padding-large no-padding-top">
            <div class="container">
                <div class="row">
                    <div class="display-header d-flex justify-content-between pb-3">
                        <h2 class="display-7 text-dark text-uppercase">${entry.key.cateName}</h2>
                        <div class="btn-right">
                            <a href="product" class="btn btn-medium btn-normal text-uppercase">View All Products</a>
                        </div>
                    </div>
                    <div class="swiper product-swiper">
                        <div class="swiper-wrapper">
