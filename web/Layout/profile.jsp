...
<html>
    ...
    <section id="profile" class="product-store position-relative padding-large no-padding-top">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <ul>
                        ...
                        <li><strong>Name:</strong> ${accountLogin.customerName}</li>
                        <li><strong>Phone:</strong> ${accountLogin.phone}</li>
                        <li><strong>Address:</strong> ${accountLogin.address}</li>
                        <li><strong>Email:</strong> ${accountLogin.email}</li>
                        
                    </ul>
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#changePasswordModal">Change Password</button>
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#updateInfoModal">Update Information</button>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="updateInfoForm" action="profile" method="post">
                        <input type="hidden" name="action" value="information" />
                        <div class="form-group">
                            <label for="name">Name</label>
                            <input type="text" class="form-control" id="name" name="name" value="${accountLogin.customerName}" required>
                        </div>
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="text" class="form-control" id="email" name="email" value="${accountLogin.email}" required>
                        </div>
                        <div class="form-group">
                            <label for="phone">Phone</label>
                            <input type="text" class="form-control" id="phone" name="phone" value="${accountLogin.phone}" required>
                        </div>
                        <div class="form-group">
                            <label for="address">Address</label>
                            <input type="text" class="form-control" id="address" name="address" value="${accountLogin.address}" required>
                        </div>
                        <button type="submit" class="btn btn-primary">Save Changes</button>
                    </form>
                </div>
