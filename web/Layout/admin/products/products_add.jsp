    ...
    <div class="row">
        ...
        <div class="col-8">
            <form method="post" action="add-product">
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">Serial Numbers</label>
                    <div id="serialInputs">
                        <input placeholder="Enter a serial number" required type="text" name="serialNumbers" class="form-control serial-input" id="exampleInputSerialNumbers" aria-describedby="emailHelp">
                    </div>
                    <button type="button" class="btn btn-primary mt-2" onclick="addSerialInput()">Add Serial Number</button>
                </div>
...
<script>
    function addSerialInput() {
        ...
        input.innerHTML = '<input type="text" name="serialNumbers" class="form-control serial-input" required placeholder="Enter serial number">' +
                          '<button type="button" class="btn btn-danger btn-sm remove-button" onclick="removeSerialInput(this)">Remove</button>';
        serialInputs.appendChild(input);
    }
    
    function removeSerialInput(button) {
