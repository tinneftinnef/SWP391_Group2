<%-- 
    Document   : product
    Created on : Jun 3, 2024, 9:48:28 PM
    Author     : HP
--%>
...
<html>
    ...
    <section id="windows" class="product-store position-relative padding-large no-padding-top">
        <div class="container">
            <div class="row" style="margin-bottom: 10px; border: 1px solid #f4f4f4; width: 50%">
                <!--<select style="margin-bottom: 20px" onChange="changeFilter(this.value)">-->
                <!--<option value="0">Select</option>-->
                <div class="col-12" style="display: flex; gap: 20px; font-size: 16px">
                    <input onClick="changeFilter(0)" id="cate-all" name="categoryId" ${categoryCurrent != null && categoryCurrent == 0 ? "checked" : ""} value="0" type="radio" ${categoryCurrent == null ? "checked" : ""}/>
                    <label for="cate-all">All</label>
                </div>
                <c:forEach items="${categories}" var="cate">
                    <div class="col-12" style="display: flex; gap: 20px; font-size: 16px">
                        <input onClick="changeFilter(${cate.cateId})" id="cate-${cate.cateId}" name="categoryId" ${categoryCurrent != null && categoryCurrent == cate.cateId ? "checked" : ""} value="${cate.cateId}" type="radio"/>
                        <label for="cate-${cate.cateId}">${cate.cateName}</label>
                    </div>
                </c:forEach>
                <!--                </select>-->
            </div>
                    ...
                    <div class="col-md-3">
                        <div class="product-card position-relative">
                            <div class="image-holder">
                                <img src="${product.image}"" alt="product-item" class="img-fluid" style="height: 200px;width: 250px">
                            </div>
    ...
    <script>
                            const changeFilter = (id) => {
                                const hrf = "${url}product?category=" + id;
