...
<html lang="en">
    ...
    <section id="billboard" class="position-relative overflow-hidden bg-light-blue p-t-75">
        <form class="bg0 p-t-75 p-b-85">
            <div class="container">
                <c:if test="${param.action != null && param.action == 'warranty' && param.type == 0}">
                    <div class="alert alert-danger" role="alert">
                        Request warranty fail
                    </div>
                </c:if>
                <c:if test="${param.action != null && param.action == 'warranty' && param.type == 1}">
                    <div class="alert alert-success" role="alert">
                        Request warranty successfully
                    </div>
                </c:if>
                <div class="row">
                    <h3>History order</h3>
                        ...
                        <tbody>
                            <c:forEach items="${orders}" var="order" varStatus="status">
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success" href="order-history?action=view&orderId=${order.orderId}">View detail</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            <c:if test="${orders.size() == 0}">
                                <tr style="text-align: center">
                                    <td colspan="10">No have order here</td>
                                </tr>
                            </c:if>
                        </tbody>
                    </table>
