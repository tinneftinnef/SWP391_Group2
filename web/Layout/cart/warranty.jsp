<%-- 
    Document   : warranty
    Created on : Jul 6, 2024, 1:44:54 AM
    Author     : HP
--%>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <table class="table table-striped mt-3">
                        ...
                        <tbody>
                            <c:forEach var="warranty" items="${warranties}" varStatus="index">
                                <tr>
                                    <td>${index.index + 1}</td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="warranty?action=view&id=${warranty.warrantyId}" class="btn btn-info">View</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            <c:if test="${warranties.size() == 0}">
                                <tr style="text-align: center">
                                    <td colspan="10">No have warranty here</td>
                                </tr>
                            </c:if>
                        </tbody>
                    </table>
