...
<html lang="en">
                ...
                <div class="row">
                                            ...
                                            <c:forEach var="cartItem" items="${carts}">
                                                ...
                                                <tr class="table_row">
                                                    ...
                                                    <td class="column-3"> 
                                                        ...
                                                        <fmt:formatNumber value="${product.price}" type="number" maxFractionDigits="0" />₫</td>
                                                    <td class="column-4">
                    ...
                    <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
                        <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                            ...
                            <c:if test="${carts.size() > 0}">
                                <a href="checkout?action=cash" class="btn btn-success">
                                    Order now
                                </a>
                            </c:if>
    ...
    <script>
        ...
        function updateCart(productId, quantity, result) {
            ...
            var url = "<%=request.getContextPath()%>/cart?action=update&productId=" + productId + "&quantity=" + quantity;
        ...
        function DeleteCart(cartId) {
            ...
            var xhr = new XMLHttpRequest();
            var url = "<%=request.getContextPath()%>/cart?action=delete&cartId=" + cartId;
