        ...
        <div class="container mt-5 mb-5">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h1 class="card-title">Warranty Details</h1>
                    <p class="${warranty.warrantyStatus == 'Active' ? 'btn btn-success' : 'btn btn-danger'}">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <p class="font-weight-bold">Warranty ID:</p>
                            <p class="text-primary">#WARRANTY${warranty.warrantyId}</p>
                        </div>
                        <div class="col-md-6">
                            <p class="font-weight-bold">Order ID:</p>
                            <a class="badge badge-primary" href="order-history?action=view&orderId=${warranty.orderId}">
                                Go to order #${warranty.orderId}
                            </a>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <p>${product != null ? product.productName : "N/A"}</p>
                        </div>
                        <div class="col-md-6">
                            <p class="font-weight-bold">Serial Number:</p>
                            <p>
                                <span class="btn btn-secondary">${warranty.serialNumber}</span>
                            </p>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <p class="font-weight-bold">Done Date:</p>
                            <p>${warranty.doneDate}</p>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <p class="font-weight-bold">Return Date:</p>
                            <p>${warranty.dateReturn != null ? warranty.dateReturn: "N/A"}</p>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <p class="font-weight-bold">Type warranty:</p>
                            <p>
                    ...
                    <a href="warranty" class="btn btn-primary">Back to warranty</a>
                </div>
            </div>
        </div>
    </section>
