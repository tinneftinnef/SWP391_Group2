...
<html>
    ...
    <section id="company-services" class="padding-large">
        <div class="container">
            <div class="row">
                <h2>Search result for "${key}" <c:if test="${products.size() == 0}">
                        No have product match
                    </c:if></h2>
            </div>
        </div>
    </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="display-header d-flex justify-content-between pb-3">
                        ...
                        <div class="btn-right">
                            <a href="product" class="btn btn-medium btn-normal text-uppercase">View all product</a>
                        </div>
                    </div>
