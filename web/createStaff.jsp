...
<html lang="en">
    ...
    <body>
        ...
        <script>var baseURL = window.location.origin + window.location.pathname; // origin là localhost + pathname là tham số ( sau dấu ?)
            window.history.replaceState({}, document.title, baseURL);// đổi đường dẫn mới</script>  
    </body>
</html>
